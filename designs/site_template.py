...
/* shared FRONT print: the HUMAN+ chest logo (same on every shirt) */
function frontDesignSVG(){
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1400">
...
function buildGarmentPage(){
  ...
  document.getElementById('sideHint').textContent=split
    ?(designSide==="front"?"Front: HUMAN+ logo (same on every shirt)":"Back: your stack design"):"";
...
function fileBase(){
  ...
  const sidePart=isSplit()?("_"+designSide):"";   // front/back only for split designs
